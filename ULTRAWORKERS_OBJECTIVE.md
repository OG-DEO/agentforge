...
Current phase:
Planning and safe foundation only.

Do not:
- Run live trading.
- Add paid APIs without approval.
- Rewrite working code without approval.
- Download huge models without checking disk space.
- Push public code without approval.
